...
+ (NSString *)sizeOfByte:(CGFloat)byte{
    if (byte<1000.0*1000.0){
        return [NSString stringWithFormat:@"%.01fKB",byte/1000.0];
    }
    else if (byte<1000.0*1000.0*1000.0){
        return [NSString stringWithFormat:@"%.01fM",byte/1000.0/1000.0];
    }
    else if (byte<1000.0*1000.0*1000.0*1000.0){
        return [NSString stringWithFormat:@"%.01fG",byte/1000.0/1000.0/1000.0];
    }
    else if (byte<1000.0*1000.0*1000.0*1000.0*1000.0){
        return [NSString stringWithFormat:@"%.01fT",byte/1000.0/1000.0/1000.0/1000.0];
    }
    return @"";
}
